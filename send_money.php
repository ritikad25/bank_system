...
<body style="background-color:#bfbfbf; padding-top:8%;">
...
if($_SERVER['REQUEST_METHOD']== 'POST'){
    ...
    $checkblcquery = "SELECT balance FROM users where accno='$sender'";
    $checkblc = mysqli_query($conn, $checkblcquery);
    $ava_blc = mysqli_fetch_assoc($checkblc)['balance'];

    if($ava_blc >= $amount){
    $sql1 = "UPDATE users SET balance= balance-$amount WHERE accno='$sender'";
    $sql2 = "UPDATE users SET balance= balance+$amount WHERE accno='$reciever'";
