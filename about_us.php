...
<body style="background-color:#cccccc;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <br><br>
            <h4 style="color:gray;">This website is created by</h4>
            <h1 style="color:white; text-shadow:5px 5px 2px gray;">Ritika Daphal</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> MIT ARTS COMMERCE AND SCIENCE,ALANDI(D),PUNE</b></p>
    </center>
